...
class Worker():              
    ...
    def run(self):
        self.code = "".join(random.choice("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890") for _ in range(19)) # https://support.discord.com/hc/en-us/articles/360020564851-Redeeming-Codes
        try:
